 ...
 */
package io.qzz.nekobounce.injection.forge.mixins.client;

import io.qzz.nekobounce.NekoBounce;
import io.qzz.nekobounce.event.*;
import io.qzz.nekobounce.features.module.modules.combat.AutoClicker;
import io.qzz.nekobounce.features.module.modules.combat.TickBase;
import io.qzz.nekobounce.features.module.modules.exploit.AbortBreaking;
import io.qzz.nekobounce.features.module.modules.exploit.MultiActions;
import io.qzz.nekobounce.features.module.modules.world.FastPlace;
import io.qzz.nekobounce.file.configs.models.ClientConfiguration;
import io.qzz.nekobounce.injection.forge.SplashProgressLock;
import io.qzz.nekobounce.ui.client.GuiMainMenu;
...
import io.qzz.nekobounce.utils.render.IconUtils;
...
import static io.qzz.nekobounce.utils.client.MinecraftInstance.mc;
...
public abstract class MixinMinecraft {
    ...
    private void init(CallbackInfo callbackInfo) {
        ...
        liquidBounce$preloadFuture = NekoBounce.INSTANCE.preload();
    }
    ...
    private void startGame(CallbackInfo callbackInfo) throws ExecutionException, InterruptedException {
        ...
        NekoBounce.INSTANCE.startClient();
    }
    ...
    private void createDisplay(CallbackInfo callbackInfo) {
        if (ClientConfiguration.INSTANCE.getClientTitle()) {
            Display.setTitle(NekoBounce.INSTANCE.getClientTitle());
        }
    }
    ...
    private void shutdown(CallbackInfo callbackInfo) {
        NekoBounce.INSTANCE.stopClient();
    }
