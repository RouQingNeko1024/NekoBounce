...
object AutoL : Module("AutoL", Category.PLAYER) {
    ...
    private  val SanGuo = listOf(
        "一破：不幸的是，你已被NekoBounce客户端击毙",
        "双连：不幸的是，你已被NekoBounce客户端击毙",
        "三连：不幸的是，你已被NekoBounce客户端击毙",
        "四连：不幸的是，你已被NekoBounce客户端击毙",
        "五连：不幸的是，你已被NekoBounce客户端击毙",
        "六连：不幸的是，你已被NekoBounce客户端击毙",
        "七连：不幸的是，你已被NekoBounce客户端击毙",
        "八连：不幸的是，你已被NekoBounce客户端击毙",
        "九连：不幸的是，你已被NekoBounce客户端击毙",
        "十连：不幸的是，你已被NekoBounce客户端击毙",
    )
