...
object LiquidWalk : Module("LiquidWalk", Category.MOVEMENT, Keyboard.KEY_J) {
    ...
    val mode by choices("Mode", arrayOf("Vanilla", "NCP", "AAC", "AAC3.3.11", "AACFly", "Spartan", "Dolphin", "Matrix"), "NCP")
    ...
    val onUpdate = handler<UpdateEvent> {
        ...
        when (mode.lowercase()) {
            ...
            "matrix" -> if (thePlayer.isInWater) {
                ...
                val blockUp = BlockUtils.getBlock(BlockPos(thePlayer.posX, thePlayer.posY + 1.1, thePlayer.posZ))
