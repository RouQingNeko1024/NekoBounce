...
object WallClimb2 : Module("WallClimb2", Category.MOVEMENT) {
    ...
    /**
     * 修复：添加重置水平运动的方法
     * 替代原来不存在的 MovementUtils.resetMotion(false)
     */
    private fun resetHorizontalMotion() {
