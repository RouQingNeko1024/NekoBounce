 ...
 */
package io.qzz.nekobounce.ui.client.hud
...
import io.qzz.nekobounce.ui.client.hud.element.elements.*
import io.qzz.nekobounce.ui.client.hud.element.elements.Target
...
object HUD : MinecraftInstance {
    ...
    private val ALL_ELEMENT_CLASSES = arrayOf(
        ...
        Arraylist_Lizz::class.java,
        ArraylistNew::class.java,
        Effects::class.java,
        Image::class.java,
