...
object NekoStyle : Style() {
    ...
    private fun getModulesByCategory(category: Category): List<Module> {
        ...
        try {
            // 尝试获取模块管理器
            val moduleManagerClass = Class.forName("net.ccbluex.liquidbounce.features.module.ModuleManager")
    ...
    override fun drawButtonElement(mouseX: Int, mouseY: Int, buttonElement: net.ccbluex.liquidbounce.ui.client.clickgui.elements.ButtonElement) {
        // NekoStyle不使用传统按钮元素
    }

    override fun drawModuleElementAndClick(
        mouseX: Int, mouseY: Int, moduleElement: net.ccbluex.liquidbounce.ui.client.clickgui.elements.ModuleElement, mouseButton: Int?
    ): Boolean {
