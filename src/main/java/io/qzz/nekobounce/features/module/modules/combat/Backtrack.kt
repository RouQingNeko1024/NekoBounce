...
import io.qzz.nekobounce.utils.client.realX
import io.qzz.nekobounce.utils.client.realY
import io.qzz.nekobounce.utils.client.realZ
import io.qzz.nekobounce.utils.extensions.*
import io.qzz.nekobounce.utils.kotlin.StringUtils.contains
...
import io.qzz.nekobounce.utils.render.RenderUtils.glColor
...
object Backtrack : Module("Backtrack", Category.COMBAT) {
    ...
    private val nextBacktrackDelay by int("NextBacktrackDelay", 0, 0..20000) { mode == "Modern" }
    private val maxDelay: Value<Int> = int("MaxDelay", 80, 0..20000).onChange { _, new ->
        new.coerceAtLeast(minDelay.get())
    }
    private val minDelay: Value<Int> = int("MinDelay", 80, 0..20000) {
        mode == "Modern"
    }.onChange { _, new ->
