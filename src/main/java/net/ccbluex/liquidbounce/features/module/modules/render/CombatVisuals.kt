...
object CombatVisuals : Module("CombatVisuals", Category.RENDER) {
    ...
    private val glowCircle = ResourceLocation("liquidbounce/texture/targetesp/glow_circle.png")
    private val rectangle = ResourceLocation("liquidbounce/texture/targetesp/rectangle.png")
    private val quadstapple = ResourceLocation("liquidbounce/texture/targetesp/quadstapple.png")
    private val trianglestapple = ResourceLocation("liquidbounce/texture/targetesp/trianglestapple.png")
    private val trianglestipple  = ResourceLocation("liquidbounce/texture/targetesp/trianglestipple.png")
    ...
    val onRender3D = handler<Render3DEvent> { event ->
        ...
        val entityLivingBase = CombatManager.target ?: return@handler
    ...
    val onAttack = handler<AttackEvent> { event ->
        ...
        // 记录攻击时间，用于防止重复效果
        targetList[target] = System.currentTimeMillis()
    }
