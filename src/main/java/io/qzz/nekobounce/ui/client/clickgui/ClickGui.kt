 ...
 */
package io.qzz.nekobounce.ui.client.clickgui

import kotlinx.coroutines.launch
import io.qzz.nekobounce.NekoBounce.moduleManager
import io.qzz.nekobounce.api.ClientApi
import io.qzz.nekobounce.api.autoSettingsList
import io.qzz.nekobounce.api.loadSettings
import io.qzz.nekobounce.config.SettingsUtils
import io.qzz.nekobounce.features.module.Category
import io.qzz.nekobounce.features.module.modules.render.ClickGUI
import io.qzz.nekobounce.features.module.modules.render.ClickGUI.guiColor
import io.qzz.nekobounce.features.module.modules.render.ClickGUI.scale
import io.qzz.nekobounce.features.module.modules.render.ClickGUI.scrolls
...
object ClickGui : GuiScreen() {
    ...
    private val nekoIcon = ResourceLocation("liquidbounce/neko.png")
    ...
    override fun drawScreen(x: Int, y: Int, partialTicks: Float) {
        ...
        assumeNonVolatile {
            ...
            val nekoWidth = 155
            val nekoHeight = 200
            val nekoX = width - nekoWidth
            val nekoY = height - nekoHeight
            drawImage(nekoIcon, nekoX, nekoY, nekoWidth, nekoHeight)
