...
import io.qzz.nekobounce.features.module.modules.misc.GameDetector
...
import io.qzz.nekobounce.ui.client.hud.element.Side.Horizontal
import io.qzz.nekobounce.ui.client.hud.element.Side.Vertical
import io.qzz.nekobounce.ui.font.AWTFontRenderer.Companion.assumeNonVolatile
import io.qzz.nekobounce.ui.font.Fonts
import io.qzz.nekobounce.utils.extensions.safeDiv
import io.qzz.nekobounce.utils.GlowUtils
import io.qzz.nekobounce.utils.render.*
import io.qzz.nekobounce.utils.render.ColorUtils.fade
import io.qzz.nekobounce.utils.render.ColorUtils.withAlpha
import io.qzz.nekobounce.utils.render.RenderUtils.deltaTime
import io.qzz.nekobounce.utils.render.RenderUtils.drawImage
...
import io.qzz.nekobounce.utils.render.animation.AnimationUtil
import io.qzz.nekobounce.utils.render.shader.shaders.GradientFontShader
import io.qzz.nekobounce.utils.render.shader.shaders.GradientShader
import io.qzz.nekobounce.utils.render.shader.shaders.RainbowFontShader
...
class ArraylistNew(
    ...
    private val glowColor by color("GlowColor", Color(0, 111, 255, 100), rainbow = true) { enableGlow }
    ...
    private val tagsColorMode by choices(
        "Tags-ColorMode", arrayOf("Custom", "Fade", "Random", "Rainbow", "Gradient"), "Custom"
    ) { tags }
    ...
    // 使用 NekoHUD 风格的阴影绘制函数
    private fun drawGlowEffect(startX: Float, startY: Float, width: Float, height: Float) {
        if (enableGlow) {
            GlowUtils.drawGlow(
                startX, startY,
                width, height,
