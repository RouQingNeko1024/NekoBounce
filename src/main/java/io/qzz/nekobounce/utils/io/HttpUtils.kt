 ...
 */
package io.qzz.nekobounce.utils.io
...
/**
 * User agent
 * NekoBounce/<version> (<commit>, <branch>, <build-type>, <platform>)
 */
val DEFAULT_AGENT =
    "${NekoBounce.CLIENT_NAME}/${NekoBounce.clientVersionText} (${NekoBounce.clientCommit}, ${NekoBounce.clientBranch}, ${if (NekoBounce.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
